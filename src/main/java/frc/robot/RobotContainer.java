...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    spinSetRotationsButton.whenPressed(mRotateWheel);
    ...
    final JoystickButton lockElevatorClampButton = new JoystickButton(mSecondaryController, Button.kBumperRight.value);
    ...
    // final JoystickButton spinToColorButton = new JoystickButton(mSecondaryController, Button.kBumperRight.value);
    // spinToColorButton.whenPressed(mAlignColor);
  }
